// napi-rs-artifact-metadata:{"version":2,"rootEntry":"index.js","exports":["compress","compressSync","uncompress","uncompressSync"],"managedRootEntries":["browser.js","index.js","snappy.wasm","snappy.debug.wasm"]}
/* eslint-disable */
/* prettier-ignore */
...
let __wasmFilePath = __nodePath.join(__dirname, 'snappy.wasm32-wasi.wasm')
const __wasmDebugFilePath = __nodePath.join(__dirname, 'snappy.wasm32-wasi.debug.wasm')
...
module.exports.compress = __napiModule.exports.compress
module.exports.compressSync = __napiModule.exports.compressSync
module.exports.uncompress = __napiModule.exports.uncompress
module.exports.uncompressSync = __napiModule.exports.uncompressSync
